        ...
        return (
            <div className="app-settings-page">
                ...
                <div className="app-settings-page-sidebar p-3 bg-lighter-1">
                    ...
                    <div className="my-3">
                        <p>
                            {`${strings.appSettings.commit}: `} {process.env.REACT_APP_COMMIT_SHA}
                        </p>
                    </div>
                    {isElectron() && (
                        <span>
                            <div className="my-3">
                                ...
                                >
                                    {strings.appSettings.devTools.button}
                                </button>
                            </div>
                            <div className="my-3">
                                <p>{strings.appSettings.reload.description}</p>
                                <button id="refreshApp" className="btn btn-primary btn-sm" onClick={this.reloadApp}>
