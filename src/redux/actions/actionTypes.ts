...
export enum ActionTypes {
    ...
    SAVE_PROJECT_IMAGES_SUCCESS = "SAVE_PROJECT_IMAGES_SUCCESS",
    ...
    // Track
    TRACK_SIGN_IN_SUCCESS = "TRACK_SIGN_IN_SUCCESS",
    TRACK_SIGN_OUT_SUCCESS = "TRACK_SIGN_OUT_SUCCESS",
    TRACK_IMG_IN_SUCCESS = "TRACK_IMG_IN_SUCCESS",
    TRACK_IMG_VALIDATE_SUCCESS = "TRACK_IMG_VALIDATE_SUCCESS",
    TRACK_IMG_DELETE_SUCCESS = "TRACK_IMG_DELETE_SUCCESS",
